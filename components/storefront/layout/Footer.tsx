    ...
    <footer className="border-t border-border bg-background">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
          <div className="flex flex-col items-center gap-4 text-center lg:items-start lg:text-left">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Premium fragrance decants — explore iconic scents without the commitment.
              Every bottle, a new discovery.
            </p>
            <p className="text-xs text-muted-foreground">
              123 Fragrance Lane, Dhaka 1205, Bangladesh
            </p>
          </div>
      ...
      <div className="border-t border-border px-3 py-4 lg:px-8">
        <p className="text-center text-xs text-muted-foreground lg:text-left">
          &copy; {currentYear} 10ML Perfume. All rights reserved.
        </p>
      </div>
    </footer>
  )
