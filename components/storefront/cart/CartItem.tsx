...
export default function CartItem({ item }: Props) {
  ...
  return (
    <Item className="py-6">
      <ItemMedia>
        <Image
          src={item.imageUrl || "https://images.unsplash.com/photo-1588514912908-8f5891714f8d?q=80&w=1169&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?w=120&q=120"}
          width={120}
          height={120}
      ...
      <ItemContent>
        <div className="flex justify-between gap-2">
          <div>
            <ItemTitle className="text-base tracking-tight leading-4.5">{item.name}</ItemTitle>
            ...
            <ItemTitle className="mt-3 text-base">
               {TakaFormatter.format(item.price * item.quantity)}
            </ItemTitle>
          </div>
