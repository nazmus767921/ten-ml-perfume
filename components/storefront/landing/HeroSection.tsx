...
//           <SliderProgressBar activeKey={active} />
//         </div>
...
// // ==========================================
// // ISOLATED SUBCOMPONENTS (Better DX)
// // ==========================================
...
//         }}
//       >
//         {brands.slice(0, brands.length - 1).map((b, i) => (
...
// function SliderProgressBar({ activeKey }: { activeKey: number }) {
//   return (
...
//   // 1. Track the cursor position and visibility
//   const [cursorPos, setCursorPos] = useState({ x: 0, y: 0 })
//   const [isHovered, setIsHovered] = useState(false)

//   // 2. Capture mouse movement relative to the container bounding box
...
//       // 3. Attach standard mouse event listeners
//       onMouseMove={handleMouseMove}
//       onMouseEnter={() => setIsHovered(true)}
//       onMouseLeave={() => setIsHovered(false)}
//       // Optional: Hides default browser cursor over the images so the custom one takes over
...
//             // Bring back the default cursor specifically for clickable thumbnails
...
//           // Centers the circle perfectly on the hardware cursor point
//           transform: `translate(-50%, -50%) scale(${isHovered ? 1.2 : 1})`,
//           // Creates a high-end ambient glow
//           boxShadow:
...
//           style={{
//             // 'difference' inverts colors underneath, a staple of award-winning portfolios
