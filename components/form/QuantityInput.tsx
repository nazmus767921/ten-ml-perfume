...
export function QuantityInput({
  ...
  const [localValue, setLocalValue] = React.useState<string>(controlledValue !== undefined ? controlledValue.toString() : defaultValue.toString())
  ...
  return (
    <InputGroup className="w-fit">
      <InputGroupInput
        ...
        max={max}
        step={step}
        className="w-14 [appearance:textfield] p-0 text-center font-medium [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
      />
